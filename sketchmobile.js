...
//sphere container
obj = createGraphics(600,600,WEBGL);
...
if(loadingHome < width) {
  ...
  push();
  imageMode(CENTER);
  image(logoReductedMint,(width/17)*7,(-height/5)*2,height/14,height/14);
  pop();
...
// //slider HSB
slider.position((width/2)-120, (height/2)+400);
